package simulation.modelBuilder;
...
public final class ModelBuilder {
	...
	private static List<SimulationObject> checkInDesks() {
		...
		desks.addAll(ModelComponentBuilder.queue(new Position(69.17, 58.7), 4, 5.5, false, 0));
	...
	public static Simulator eindhovenAirport(boolean gui, int timeStep) {
		...
		sittingArea = ModelComponentBuilder.sittingArea(new Position(18, 3), 6, 10, 0);
		sim.addAll(sittingArea);
		sittingArea = ModelComponentBuilder.sittingArea(new Position(33, 3), 6, 10, 0);
		sim.addAll(sittingArea);
