...
import model.agent.humanAgent.aatom.tacticalLevel.activity.operator.impl.BasicETDCheckActivity;
import model.agent.humanAgent.aatom.tacticalLevel.activity.operator.impl.BasicLuggageCheckActivity;
import model.agent.humanAgent.aatom.tacticalLevel.activity.operator.impl.BasicLuggageDropActivity;
import model.agent.humanAgent.aatom.tacticalLevel.activity.operator.impl.BasicOperatorCheckInActivity;
import model.agent.humanAgent.aatom.tacticalLevel.activity.operator.impl.BasicPhysicalCheckActivity;
import model.agent.humanAgent.aatom.tacticalLevel.activity.operator.impl.BasicTravelDocumentCheckActivity;
import model.agent.humanAgent.aatom.tacticalLevel.activity.operator.impl.BasicXRayActivity;
