...
public class ActivityModule implements Updatable {
	...
	public Activity getNextActivity() {
		return planningModule.getNextActivity();
	}
	...
	public Position getNextActivityPosition() {
		if (planningModule.getNextActivity() == null)
			return Position.NO_POSITION;
		return planningModule.getNextActivity().getActivityPosition();
	}
	...
	public void init(Map map, HumanAgent agent, MovementModule movementModel, ObservationModule observationModule,
			Collection<Activity> activities, PlanningModule planner, NavigationModule navigationModule) {
		this.activities = activities;
		this.planningModule = planner;
	...
	public void update(int timeStep) {
		...
		Activity curr = planningModule.getNextActivity();
