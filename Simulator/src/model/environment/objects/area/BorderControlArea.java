...
public class BorderControlArea extends Area {
	 ...
	 */
	public BorderControlArea(double topX, double topY, double width, double height) {
	 ...
	 */
	public BorderControlArea(double x0, double x1, double x2, double x3, double y0, double y1, double y2, double y3) {
	 ...
	 *            The y coordinates.
	 */
	public BorderControlArea(double[] x, double[] y) {
		super(x, y);
	}
