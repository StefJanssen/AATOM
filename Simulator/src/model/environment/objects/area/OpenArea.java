...
public class OpenArea extends Area {
	 ...
	 */
	public OpenArea(double topX, double topY, double width, double height) {
	 ...
	 */
	public OpenArea(double x0, double x1, double x2, double x3, double y0, double y1, double y2, double y3) {
	 ...
	 *            The y coordinates.
	 */
	public OpenArea(double[] x, double[] y) {
		super(x, y);
	}
	 ...
	 */
	public OpenArea(List<Position> corners) {
		super(corners);
	}
}