...
public class CheckpointArea extends Area {
	 ...
	 */
	public CheckpointArea(double topX, double topY, double width, double height) {
	 ...
	 */
	public CheckpointArea(double x0, double x1, double x2, double x3, double y0, double y1, double y2, double y3) {
	 ...
	 *            The y coordinates.
	 */
	public CheckpointArea(double[] x, double[] y) {
		super(x, y);
	}
	 ...
	 */
	public CheckpointArea(List<Position> corners) {
		super(corners);
	}
}