...
public class SecureArea extends Area {
	 ...
	 */
	public SecureArea(double topX, double topY, double width, double height) {
	 ...
	 */
	public SecureArea(double x0, double x1, double x2, double x3, double y0, double y1, double y2, double y3) {
	 ...
	 *            The y coordinates.
	 */
	public SecureArea(double[] x, double[] y) {
		super(x, y);
	}
