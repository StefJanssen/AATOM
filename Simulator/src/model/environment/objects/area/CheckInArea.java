...
public class CheckInArea extends Area {
	 ...
	 */
	public CheckInArea(double topX, double topY, double width, double height) {
	 ...
	 */
	public CheckInArea(double x0, double x1, double x2, double x3, double y0, double y1, double y2, double y3) {
	 ...
	 *            The y coordinates.
	 */
	public CheckInArea(double[] x, double[] y) {
		super(x, y);
	}
